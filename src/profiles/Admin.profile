...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Diseny__c.Mood__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Diseny__c.Roll_Number__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Diseny__c-Diseny Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Fairy__c-Fairy Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>First_Visual_Force_Page</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>Second_VF</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
